...
<head style="background: linear-gradient(to right, #ffffcc 0%, #66ffcc 100%);">
 ...
 <nav class="navbar navbar-dark bg-white navbar-expand-sm  fixed-top" style="background: linear-gradient(to right, #ffffcc 0%, #66ffcc 100%);">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="Navbar">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item "><a class="nav-link"  href="#" style="color:#E75480; font-weight: bold"><span class="fa fa-home fa-lg"></span> Home</a></li>
        ...
        <div class="container">
            ...
            <a class="navbar-brand mr-auto" style="color: #E75480"><i>Sparks Bank</i></a>
            <div class="collapse navbar-collapse" id="Navbar">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item "><a class="nav-link" href="index.html" style="color:#E75480"><span class="fa fa-home fa-lg"></span> Home</a></li>
                     <li class="nav-item active"><a class="nav-link" href="allusers.php" style="color: #E75480"><i class="fa fa-user-o" aria-hidden="true"></i></i> View Users</a></li>
